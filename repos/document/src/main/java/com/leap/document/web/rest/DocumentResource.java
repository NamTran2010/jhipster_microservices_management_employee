...
import com.leap.document.service.DocumentService;
import com.leap.document.service.dto.DocumentDTO;
import com.leap.document.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
public class DocumentResource {
     ...
     *         the updated documentDTO,
     *         or with status {@code 400 (Bad Request)} if the documentDTO is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the documentDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<DocumentDTO> updateDocument(
            ...
            @Valid @RequestBody DocumentDTO documentDTO) throws URISyntaxException {
     ...
     *         or with status {@code 400 (Bad Request)} if the documentDTO is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the documentDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the documentDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<DocumentDTO> partialUpdateDocument(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody DocumentDTO documentDTO) throws URISyntaxException {
