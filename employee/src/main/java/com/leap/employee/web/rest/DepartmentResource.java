...
import com.leap.employee.repository.DepartmentRepository;
import com.leap.employee.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.leap.employee.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
     ...
     *         the updated departmentDTO,
     *         or with status {@code 400 (Bad Request)} if the departmentDTO is not
     *         valid,
    ...
    public ResponseEntity<DepartmentDTO> updateDepartment(
            ...
            @Valid @RequestBody DepartmentDTO departmentDTO) throws URISyntaxException {
     ...
     *         or with status {@code 400 (Bad Request)} if the departmentDTO is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the departmentDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         departmentDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<DepartmentDTO> partialUpdateDepartment(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody DepartmentDTO departmentDTO) throws URISyntaxException {
