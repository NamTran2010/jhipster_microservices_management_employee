...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).hireDate(DEFAULT_HIRE_DATE).salary(DEFAULT_SALARY);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).hireDate(UPDATED_HIRE_DATE).salary(UPDATED_SALARY);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).hireDate(UPDATED_HIRE_DATE).salary(UPDATED_SALARY);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).hireDate(UPDATED_HIRE_DATE).salary(UPDATED_SALARY);
